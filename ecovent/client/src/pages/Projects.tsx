...
const defaultProjects = [
  {
    ...
    descriptionAr: "تصميم وتنفيذ نظام تهوية متكامل لمصنع ألبان بمساحة 50,000 متر مربع، يشمل أنظمة التبريد والتحكم في الرطوبة والتعقيم.",
  ...
  },
  {
    ...
    descriptionAr: "تركيب أنظمة تبريد دقيقة لمركز بيانات بسعة 500 خادم، مع أنظمة احتياطية ومراقبة على مدار الساعة.",
  ...
  },
  {
    ...
    descriptionAr: "تجهيز غرف العمليات والعناية المركزة بأنظمة تهوية معقمة وفق أعلى المعايير الطبية العالمية.",
